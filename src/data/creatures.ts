...
export const creatures: Creature[] = [
  {
    ...
    description: '# Tyrannosaurus rex (T. rex)\n\n## Overview\n**Tyrannosaurus rex**, commonly abbreviated as **T. rex**, is one of the most iconic and extensively studied dinosaurs. It lived approximately **68–66 million years ago** during the **Late Cretaceous period**, inhabiting what is now **western North America**.\n\n---\n\n## Taxonomy & Classification\n- **Clade:** Theropoda  \n- **Diet:** Carnivorous  \n- **Locomotion:** Bipedal  \n\nAs a theropod dinosaur, T. rex shared evolutionary traits with other bipedal carnivores, including a large skull and a long, counterbalancing tail.\n\n---\n\n## Physical Characteristics\n\n### Size & Build\n- **Length:** Over 12 meters  \n- **Weight:** Estimated **6–9 metric tons**  \n- **Posture:** Upright, bipedal stance  \n\nDespite its massive size, T. rex was relatively agile for a predator of its scale.\n\n### Limbs\n- **Forelimbs:** Very short, with **two clawed digits**  \n- **Hind limbs:** Powerful and well-developed  \n\nThe exact function of its small arms remains debated, with theories ranging from grasping prey to aiding in mating or balance.\n\n---\n\n## Skull & Dentition\n\n### Skull Structure\n- Exceptionally large skull, up to **1.5 meters long**\n- **Wide at the rear**, narrow at the snout\n- Bones were **fused and pneumatized** (contained air spaces)\n\nThis structure contributed to both strength and weight reduction.\n\n### Bite Force & Teeth\n- Among the **strongest bite forces** of any terrestrial animal\n- **Heterodont dentition** (teeth varied in shape and size)\n  - Front teeth: **D-shaped**, tightly packed\n  - Rear teeth: Large, widely spaced, extremely robust\n- Some teeth exceeded **30 centimeters**, the largest known in carnivorous dinosaurs\n\n---\n\n## Sensory Capabilities\nT. rex possessed highly advanced senses for a dinosaur:\n\n- **Vision:**  \n  - Exceptional binocular vision (~55° overlap)  \n  - Likely superior to that of modern hawks\n- **Smell:**  \n  - Large olfactory bulbs suggest a **keen sense of smell**\n- **Touch:**  \n  - Evidence points to a **highly sensitive snout**, possibly covered in scales or specialized integument\n\nThese traits indicate a predator finely tuned for detecting prey and interacting with its environment.\n\n---\n\n## Behavior & Ecology\n\n### Feeding Strategy\nCurrent consensus suggests T. rex was:\n- An **active predator**\n- A **scavenger** when opportunities arose  \n\nLikely prey included:\n- Hadrosaurs  \n- Ceratopsians  \n- Possibly juvenile or weakened sauropods  \n\n### Social & Functional Behavior\n- Sensitive snout may have been used for:\n  - Nest building\n  - Social interaction\n  - Environmental exploration  \n\n---\n\n## Growth & Biology\n- Ongoing research continues to refine understanding of:\n  - Growth rates\n  - Biomechanics\n  - Life stages\n- Discovery of **soft tissue and preserved proteins** in some specimens has provided rare insight into:\n  - Physiology\n  - Evolutionary relationships\n\n---\n\n## Cultural Significance\nT. rex holds an unparalleled place in popular culture:\n- Featured prominently in **films**, **literature**, and **media**\n- Serves as the **archetypal dinosaur** in public imagination\n- Symbolizes power, fear, and prehistoric life\n\n---\n\n## Ongoing Research\nScientific study of T. rex remains active, with new discoveries continually reshaping our understanding of:\n- Its ecology\n- Its role in Late Cretaceous ecosystems\n- The evolutionary history of large theropod dinosaurs\n\n---\n\n*Few prehistoric animals have captured both scientific attention and popular imagination as completely as Tyrannosaurus rex.*\n',
    category: 'Dinosaurs',
  ...
  },
  {
    ...
    description: '# Deinotherium\n\n## Overview\n**Deinotherium**, meaning "terrible beast," was one of the **largest land mammals ever**—a prehistoric relative of elephants with a bizarre twist: its tusks curved **downward** from its lower jaw instead of upward! Living approximately **20-1 million years ago** from the Miocene to Pleistocene, this giant roamed across Africa, Europe, and Asia.\n\n---\n\n## Taxonomy & Classification\n- **Order:** Proboscidea (elephants and relatives)\n- **Family:** Deinotheriidae\n- **Diet:** Herbivorous\n- **Type:** Prehistoric elephant relative\n\nDeinotherium was NOT a direct ancestor of modern elephants—it was a **cousin** that went extinct.\n\n---\n\n## Physical Characteristics\n\n### Size & Build\n- **Height:** 3.5-5 meters (11.5-16 feet) at the shoulder\n- **Length:** About 7 meters (23 feet)\n- **Weight:** 8,800-12,000 kg (9.7-13.2 tons)\n- One of the **largest land mammals ever**!\n\n### Those Backward Tusks\nDeinotherium\'s strangest feature:\n- Tusks curved **downward** from the **lower jaw**\n- Upper jaw had **no tusks at all**!\n- Opposite of modern elephants\n- Made it look like nothing alive today\n\n---\n\n## What Were the Tusks For?\n\n### Possible Uses\nScientists have several ideas:\n- **Stripping bark** from trees\n- **Digging** for roots and tubers\n- **Pulling down branches** to eat leaves\n- **Display** for attracting mates or intimidating rivals\n- **Defense** against predators\n\n---\n\n## Giant of Three Continents\n\n### Where It Lived\nDeinotherium fossils found in:\n- **Africa** (Kenya, Ethiopia)\n- **Europe** (Germany, Greece, Spain)\n- **Asia** (India, Pakistan)\n- Spread across the **Old World**\n- Lived in **forests and woodlands**\n\n---\n\n## Living with Early Humans\n\n### Ancient Encounters\nDeinotherium may have met our ancestors:\n- Lived until about **1 million years ago**\n- Early humans (**Homo erectus**) were alive by then\n- May have been **hunted** by early humans\n- Possibly inspired myths of **strange giant beasts**\n\n---\n\n## Deinotherium vs. Modern Elephants\n\n| Feature | Deinotherium | African Elephant |\n|---------|--------------|------------------|\n| Height | Up to 5m | Up to 4m |\n| Tusks | Lower jaw, down | Upper jaw, up |\n| Trunk | Yes | Yes |\n| Weight | 12,000 kg | 6,000 kg |\n| Status | Extinct | Endangered |\n\nDeinotherium was **bigger** with **backwards tusks**!\n\n---\n\n## Why Did It Go Extinct?\n\n### Climate Change\nDeinotherium disappeared because:\n- **Ice Ages** changed their habitat\n- Forests became **grasslands**\n- Couldn\'t adapt as well as true elephants\n- **Competition** with other animals\n- Possibly **hunted** by early humans\n\n---\n\n## Cool Facts\n\n- Deinotherium means **"terrible beast"** in Greek\n- Its tusks grew from the **lower jaw**—opposite of all other elephants!\n- It was **taller** than modern elephants\n- May have been seen by **early humans**!\n- Scientists once thought the tusks were **horns**\n- Lived for about **19 million years** as a genus\n- One of the most **successful** prehistoric elephants\n\n---\n\n*Deinotherium was the upside-down elephant—a giant of the ancient world whose backward tusks prove evolution loves to experiment!*',
    category: 'Early Mammals',
    subcategory: 'Prehistoric Mammals',
    family: 'Deinotheriidae',
  ...
  },
  {
    ...
    description: '# Nigersaurus taqueti\n\n## Overview\n**Nigersaurus**, often called the "Mesozoic cow," was one of the **strangest sauropods** ever discovered! Living approximately **110-105 million years ago** during the middle Cretaceous period in what is now Niger, Africa, this unusual dinosaur had a mouth shaped like a **vacuum cleaner** and more teeth than almost any other dinosaur!\n\n---\n\n## Taxonomy & Classification\n- **Clade:** Sauropoda\n- **Family:** Rebbachisauridae\n- **Diet:** Herbivorous\n- **Locomotion:** Quadrupedal\n\nNigersaurus was a smaller relative of giant sauropods like Brachiosaurus.\n\n---\n\n## Physical Characteristics\n\n### Size & Build\n- **Length:** About 9 meters (30 feet)\n- **Weight:** 2,000-4,000 kg (2-4 tons)\n- **Height:** About 2 meters at the hip\n\nMuch **smaller** than famous sauropods—more like a large elephant than a giant!\n\n### The Vacuum Cleaner Mouth\nNigersaurus\'s most bizarre feature:\n- Mouth was **wider than the rest of its skull**!\n- Shaped like a **straight line** across the front\n- Looked like a **vacuum cleaner nozzle**\n- Perfect for **mowing down ground-level plants**\n\n### Incredible Teeth\n- Had **500+ teeth** at any given time!\n- Teeth arranged in **columns** of 9+ teeth each\n- When one tooth wore out, another **replaced it from behind**\n- Replaced teeth approximately every **14 days**!\n- **Fastest tooth replacement** of any dinosaur\n\n---\n\n## The Unique Skull\n\n### Lightweight Design\n- Skull was incredibly **thin and delicate**\n- Bones were **nearly paper-thin** in places\n- More holes (fenestrae) than bone!\n- So fragile that fossils are **rarely preserved**\n- Scientists describe it as "more skull holes than skull"\n\n### Downward-Facing Head\n- Neck held **horizontally**\n- Head pointed **straight down** at the ground\n- Could not lift its head very high\n- Perfectly adapted for **ground-level grazing**\n\n---\n\n## Feeding Behavior\n\n### Prehistoric Lawn Mower\nNigersaurus was a specialized feeder:\n- Grazed on **ferns, horsetails**, and low plants\n- **Swung its head** side to side to crop vegetation\n- Like a **biological lawn mower**!\n- Could clear vegetation **efficiently and quickly**\n\n### Tooth Batteries\n- Teeth only on the **front edge** of the mouth\n- Self-sharpening as they wore down\n- Arranged in **dental batteries**\n- Similar system to hadrosaurs (duck-billed dinosaurs)\n\n---\n\n## Discovery Story\n\n### Found in the Sahara\n- First bones found in **1976**\n- Properly described in **1999** by Paul Sereno\n- Found in **Niger, Africa** (hence the name)\n- The Sahara was a **lush floodplain** back then!\n- Fossils are extremely **fragile and rare**\n\n---\n\n## Brain & Senses\n\n### Small Brain, Big Success\n- Brain was about the size of a **tennis ball**\n- But the brain\'s inner ear shows:\n  - Head was typically held **at 67 degrees downward**\n  - Confirms it was a **ground-level feeder**\n- CT scans revealed its **lifestyle through anatomy**!\n\n---\n\n## Environment\n\n### Ancient Niger\nNigersaurus lived in:\n- **Lush floodplains** and **river deltas**\n- Tropical, **humid climate**\n- Alongside crocodiles and large fish\n- Other dinosaurs like **Ouranosaurus** and **Suchomimus**\n- Now the **Sahara Desert**—completely different today!\n\n---\n\n## Cool Facts\n\n- Nigersaurus had more teeth than **any other sauropod**!\n- New teeth grew every **two weeks**\n- Its skull was so thin you could **see light through it**\n- Nicknamed the "**Mesozoic cow**" for its grazing habits\n- Could not raise its head to **look at the sky**\n- Found in what is now one of the **hottest deserts on Earth**\n- The internet once called it the dinosaur with the "**weirdest face**"\n- Its nostrils were on the **top of its snout**, not the front\n\n---\n\n*Nigersaurus shows us that dinosaurs came in all shapes and styles—this bizarre "vacuum cleaner" dinosaur was perfectly designed for its specialized lifestyle!*',
    category: 'Dinosaurs',
    subcategory: 'Sauropods',
    family: 'Rebbachisauridae',
  ...
  },
  {
    ...
    description: '# Micropachycephalosaurus hongtuyanensis\n\n## Overview\n**Micropachycephalosaurus** holds a very special record—it has the **longest dinosaur name ever**! This tiny dinosaur, whose name means "**small thick-headed lizard**," lived during the Late Cretaceous period, about **70 million years ago** in what is now China. Despite its enormous name, it was one of the **smallest dinosaurs** known!\n\n---\n\n## Taxonomy & Classification\n- **Clade:** Marginocephalia\n- **Family:** Ceratopsia (probably—classification uncertain!)\n- **Diet:** Herbivorous\n- **Locomotion:** Bipedal\n\nDespite its name, Micropachycephalosaurus might **NOT actually be a pachycephalosaur** at all!\n\n---\n\n## Physical Characteristics\n\n### Tiny Size\n- **Length:** Only about 1 meter (3 feet)\n- **Weight:** 2.3-4.5 kg (5-10 lbs)\n- **Height:** About 30 cm (1 foot) at hip\n- **Build:** Small, lightweight, bipedal\n\n### Body Features\n- **Small head** (not heavily domed like true pachycephalosaurs)\n- **Long legs** for running\n- **Small teeth** for eating plants\n- **Lightweight skeleton**\n- Built for **speed**, not fighting!\n\n---\n\n## The Name Record!\n\n### Longest Dinosaur Name Ever!\n\n| Dinosaur | Letters | Meaning |\n|----------|---------|--------|\n| **Micropachycephalosaurus** | **23 letters** | Small thick-headed lizard |\n| Carcharodontosaurus | 19 letters | Shark-toothed lizard |\n| Pachycephalosaurus | 18 letters | Thick-headed lizard |\n| Tyrannosaurus | 13 letters | Tyrant lizard |\n\nTry saying "Micropachycephalosaurus" **five times fast**!\n\n### How to Pronounce It\n**MY-kro-PACK-ee-SEF-ah-lo-SORE-us**\n\nBreak it down:\n- Micro = small\n- Pachy = thick\n- Cephalo = head\n- Saurus = lizard\n\n---\n\n## Classification Mystery\n\n### Is It Really a Pachycephalosaur?\nScientists aren\'t sure:\n- Original fossils are **very fragmentary**\n- Skull isn\'t **obviously domed**\n- Might be an **early ceratopsian** instead\n- Could be a **completely different** kind of dinosaur\n- Need **more fossils** to know for sure!\n\n---\n\n## Feeding & Diet\n\n### Small Plant-Eater\nMicropachycephalosaurus likely ate:\n- **Ferns** and low plants\n- **Seeds** and small vegetation\n- **Soft plant material**\n- Whatever it could reach at **ground level**\n\n### Survival Strategy\n- Too small to **fight predators**\n- Relied on **speed** to escape\n- May have hidden in **vegetation**\n- Probably lived in **groups** for safety\n\n---\n\n## Cretaceous China\n\n### Where It Lived\nFound in:\n- **Shandong Province**, eastern China\n- Late Cretaceous period (~70 mya)\n- Alongside **other small dinosaurs**\n- In **mixed forest/plain** environments\n\n---\n\n## Discovery\n\n### A Fragmentary Fossil\n- Discovered in **1978**\n- Named by **Dong Zhiming** (famous Chinese paleontologist)\n- Very **incomplete skeleton**\n- Only partial skull and some bones\n- Classification has been **debated ever since**\n\n---\n\n## Size Comparison\n\n### One of the Smallest!\n\n| Dinosaur | Length |\n|----------|--------|\n| T. rex | 12 meters |\n| Velociraptor | 2 meters |\n| **Micropachycephalosaurus** | **1 meter** |\n| Chicken | 0.3 meters |\n\nAbout the size of a **large cat**!\n\n---\n\n## Cool Facts\n\n- Has the **longest name** of any dinosaur—**23 letters**!\n- Scientists shorten it to "**Micropachycephalosaurus**" or "**Micro**"\n- Despite the name, it probably **wasn\'t a pachycephalosaur**!\n- One of the **smallest known dinosaurs**\n- The fossils are so incomplete, we\'re not even sure **what it looked like**\n- Named in **1978** during China\'s dinosaur discovery boom\n- Would fit on a **small dog bed**\n- Proof that dinosaurs came in **all sizes**—not just giant!\n\n---\n\n*Micropachycephalosaurus may have been tiny, but it has the biggest name in the dinosaur world—a record that\'s hard to beat when you need 23 letters just to say hello!*',
    category: 'Dinosaurs',
    subcategory: 'Ceratopsians',
